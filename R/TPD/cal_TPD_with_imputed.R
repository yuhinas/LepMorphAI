...
X = fread('../../save/vsc_epoch_40000/pred_fam/no_neg/top2/pca_highlights/fam_mean/sp_mean_on_fam_mean_pca.csv', header = T)
...
meta = fread('../../save/vsc_epoch_40000/pred_fam/no_neg/top2/pca_highlights/fam_mean/moth_geometry_with_meta.csv')
...
X_imputed = rbind(X_refined, X_fam_sp_not_enough_median, X_fam_sp_not_enough)
X_imputed = X_imputed[order(family)][order(groups, decreasing = T)]
...
#plotTPD(TPDc_del)
source('plotTPD.R')
pdf(file = "revised2_TPDc_100MA_PC12.pdf",   # The directory you want to save the file in
    width = 4, # The width of the plot in inches
    height = 8) # The height of the plot in inches
png(file = "revised2_TPDc_100MA_PC12.png",   # The directory you want to save the file in
    width = 400,
    height = 800)
plotTPD(TPDc_imp, probColors = c('dodgerblue4', 'firebrick3'), leg.text = c('Primitive', 'Recent'))
dev.off()

pdf(file = "revised2_TPDc_100MA_PC13.pdf",   # The directory you want to save the file in
    width = 4, # The width of the plot in inches
    height = 8) # The height of the plot in inches
png(file = "revised2_TPDc_100MA_PC13.png",   # The directory you want to save the file in
    width = 400,
    height = 800)
...
pdf(file = "revised2_TPDc_100MA_PC23.pdf",   # The directory you want to save the file in
    width = 4, # The width of the plot in inches
    height = 8) # The height of the plot in inches
png(file = "revised2_TPDc_100MA_PC23.png",   # The directory you want to save the file in
    width = 400,
    height = 800)
